...
export async function GET(_req: Request, { params }: { params: { storeId: string, categoryId: string } }) {
    try {
...
export async function PATCH(req: Request,
    ...
    try {
        ...
        if (!billboardId) return new NextResponse('Billborad id is required', { status: 400 })
