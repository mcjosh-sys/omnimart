...
export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const getSelectedColor = () => {
        const id = form.getValues().colorId
        return colors.filter(color => color.id === id)[0]?.value || 'none'
    }
    ...
    return (
        <>
            <AlertModal
                ...
                loading={loading}
            />
            <div className="space-y-3 max-w-7xl m-auto"> 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="flex items-center gap-x-2">
                                        Color
                                        <div className="rounded-full border h-6 w-6" style={{ backgroundColor: getSelectedColor() }} />
                                    </FormLabel>
                                    <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger>
