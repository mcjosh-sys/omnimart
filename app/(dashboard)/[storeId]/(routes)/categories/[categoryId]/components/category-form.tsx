...
export const CategoryForm: React.FC<CategoryFormProps> = ({ initialData, billboards }) => {
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error('Make sure your\'ve removed all prodducts using this category before deleting')
        } finally {
            setLoading(false)
            setOpen(false)
        }
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue defaultValue={field.value} placeholder='Select a billiboard' />
                                            </SelectTrigger>
                                        </FormControl>
                                        <SelectContent>
